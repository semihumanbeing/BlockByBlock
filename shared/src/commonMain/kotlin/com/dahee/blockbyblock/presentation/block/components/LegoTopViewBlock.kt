...
fun getFoodBlockTopDrawable(colorHex: String, moldCapacityMl: Int = 250): DrawableResource {
    ...
    return when (category) {
        ...
        BlockSizeCategory.LARGE -> when {
            isRed -> Res.drawable.food_block_top_3x4_red
            isYellow -> Res.drawable.food_block_top_3x4_yellow
            isGreen -> Res.drawable.food_block_top_3x4_green
            isWhite -> Res.drawable.food_block_top_3x4_white
            else -> Res.drawable.food_block_top_3x4_orange
        }
        // MEDIUM (미디엄: 2x4, 201 ~ 399ml)
        BlockSizeCategory.MEDIUM -> when {
            isRed -> Res.drawable.food_block_top_2x4_red
            isYellow -> Res.drawable.food_block_top_2x4_yellow
            isGreen -> Res.drawable.food_block_top_2x4_green
            isWhite -> Res.drawable.food_block_top_2x4_white
            else -> Res.drawable.food_block_top_2x4_orange
        }
        // SMALL (스몰: 1x4, 101 ~ 200ml)
        BlockSizeCategory.SMALL -> when {
            isRed -> Res.drawable.food_block_top_1x4_red
            isYellow -> Res.drawable.food_block_top_1x4_yellow
            isGreen -> Res.drawable.food_block_top_1x4_green
            isWhite -> Res.drawable.food_block_top_1x4_white
            else -> Res.drawable.food_block_top_1x4_orange
        }
        // MINI (미니: 2x2, 0 ~ 100ml)
        BlockSizeCategory.MINI -> when {
            isRed -> Res.drawable.food_block_top_2x2_red
            isYellow -> Res.drawable.food_block_top_2x2_yellow
            isGreen -> Res.drawable.food_block_top_2x2_green
            isWhite -> Res.drawable.food_block_top_2x2_white
            else -> Res.drawable.food_block_top_2x2_orange
        }
    }
}

/**
 * Top-down Lego Food Block component loaded directly from drawable resources matching reference.
 */
@Composable
fun LegoTopViewBlock(
    colorHex: String,
    ...
    val finalWidth = width ?: when (category) {
        BlockSizeCategory.LARGE -> 72.dp       // 3x4 라지
        BlockSizeCategory.SMALL -> 26.dp       // 1x4 스몰
        BlockSizeCategory.MINI -> 50.dp        // 2x2 미니
        BlockSizeCategory.MEDIUM -> 50.dp      // 2x4 미디엄
    }

    val finalHeight = if (category == BlockSizeCategory.MINI && width == null) 50.dp else height
    ...
    Box(
        ...
        Image(
            ...
            contentDescription = "Top-view Lego Food Block",
            modifier = Modifier
                .width(finalWidth)
                .height(finalHeight)
        )
