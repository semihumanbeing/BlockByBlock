...
data class IngredientUiState(
    ...
    val catalogPagedResults: List<CatalogIngredient> = MasterIngredientCatalog.items.take(20),
    val catalogCurrentPage: Int = 1,
    val catalogPageSize: Int = 20,
    val catalogTotalPages: Int = 1,
    val catalogHasNextPage: Boolean = false,
    val isCatalogLoadingNextPage: Boolean = false,
    val isCatalogInitialLoading: Boolean = false,
